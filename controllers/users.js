      ...
      await newUser.save().then(() => {
        ...
        let mailOptions = {
          ...
          text: 'Please click on the following link to verify your account: \n\n' +
            ...
            'https://www.icgroupsfx.com/users/verify/' + uniqueString + '\n\n'
        };
...
module.exports.getVerified = async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      text: 'Please click on the following link to verify your account: \n\n' +
        // add https to this and o the nuxt app home page and change the url
        'https://www.icgroupsfx.com/users/verify/' + userFound.uniqueString + '\n\n'
    };
    smtpTransport.sendMail(mailOptions, function (err) {
      if (err) {
        console.log(err);
    ...
    function (token, user, done) {
      ...
      const mailOptions = {
        ...
        text: 'You are receiving this because you (or someone else) have requested the reset of the password for your account.\n\n' +
          ...
          'https://www.icgroupsfx.com/users/reset/' + token + '\n\n' +
